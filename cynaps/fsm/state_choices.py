...
"""
Core state choice enums for Cynaps entities.
These enums define the essential states for core Cynaps entities.
"""
...
class TaskStateChoices(models.TextChoices):
    """
    Core task states for basic Cynaps workflow.
...
class AnnotationStateChoices(models.TextChoices):
    """
    Core annotation states for basic Cynaps workflow.
...
class ProjectStateChoices(models.TextChoices):
    """
    Core project states for basic Cynaps workflow.
