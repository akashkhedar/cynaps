...
# =============================================================================
# Core State Models for Cynaps OSS
# =============================================================================
...
class TaskState(BaseState):
    """
    Core task state tracking for Cynaps.
...
class AnnotationState(BaseState):
    """
    Core annotation state tracking for Cynaps.
...
class ProjectState(BaseState):
    """
    Core project state tracking for Cynaps.
