...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Save details for a specific user, such as their name or contact information, in Cynaps.
    """,
        parameters=[
...
@method_decorator(
    ...
    decorator=extend_schema(
        tags=['Users'],
        summary='List users',
        description='List the users that exist on Cynaps server.',
        extensions={
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description='Create a user in Cynaps.',
        request={
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description='Get info about a specific Cynaps user, based on the user ID.',
        parameters=[
            OpenApiParameter(name='id', type=OpenApiTypes.INT, location='path', description='User ID'),
        ],
        request=None,
...
@method_decorator(
    ...
    decorator=extend_schema(
        tags=['Users'],
        summary='Delete user',
        description='Delete a specific Cynaps user.',
        parameters=[
            OpenApiParameter(name='id', type=OpenApiTypes.INT, location='path', description='User ID'),
        ],
        request=None,
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        extensions={
            'x-fern-sdk-group-name': 'users',
            'x-fern-sdk-method-name': 'change_password',
            'x-fern-audiences': ['public'],
        },
    ),
)
class UserChangePasswordAPI(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        logger.info(f'Password changed for user {user.pk}')
