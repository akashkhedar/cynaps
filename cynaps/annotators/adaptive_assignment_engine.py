...
class AdaptiveAssignmentEngine:
    ...
    def has_capacity(annotator, project):
        ...
        try:
            trust_level = annotator.trust_level.level if hasattr(annotator, 'trust_level') and annotator.trust_level else "novice"
        except Exception:
            trust_level = "novice"
    ...
    def score_annotator_for_task(annotator, task, project):
        ...
        trust_scores = {"new": 50, "junior": 60, "regular": 75, "senior": 90, "expert": 100, "novice": 60, "intermediate": 75, "master": 100}
        try:
            trust_level = annotator.trust_level.level if hasattr(annotator, 'trust_level') and annotator.trust_level else "new"
        except Exception:
            trust_level = "new"
