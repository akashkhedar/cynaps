...
from . import api
from . import views
from . import payout_action_views, honeypot_api
...
urlpatterns = [
    ...
    path("auth-check", api.AnnotatorAuthCheckAPI.as_view(), name="auth-check"),
    path(
        "resend-verification",
    ...
    path(
        "payouts/<int:payout_id>/upi-redirect",
        api.UPIRedirectAPI.as_view(),
        name="payout-upi-redirect",
    ),
    path(
        "public/payouts/<str:payout_id>/action/success",
        payout_action_views.manual_payout_success_view,
        name="public-payout-success",
    ),
    path(
        "public/payouts/<str:payout_id>/action/failed",
        payout_action_views.manual_payout_failed_view,
        name="public-payout-failed",
    ),
    ...
    path(
        "admin/payouts/<int:payout_id>/manual-approve",
        api.AdminPayoutManualApproveAPI.as_view(),
        name="admin-payout-manual-approve",
    ),
    path(
