...
class ExpertAssignmentEngine:
    ...
    def check_and_process_timeouts(cls, project=None):
        ...
        # Track experts already marked inactive to avoid duplicate processing
        ...
        for review in queryset:
            # Skip if expert was already marked inactive in this batch
            if review.expert_id in inactive_experts:
                # Just release this review without re-marking expert
                cls._release_review(review)
                released += 1
                continue
            ...
            if result == 'extended':
                ...
                inactive_experts.add(review.expert_id)
                marked_inactive += 1
