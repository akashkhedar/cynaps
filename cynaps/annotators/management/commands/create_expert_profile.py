...
Usage:
    ...
    python manage.py create_expert_profile <email> --areas classification bounding_box
"""
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        # NOTE: expertise_level removed - all experts are equal now
        parser.add_argument(
            "--areas",
            type=str,
            nargs="+",
    ...
    def handle(self, *args, **options):
        ...
        # Create expert profile (no expertise_level - all experts are equal)
