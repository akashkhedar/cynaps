...
from cynaps_sdk._extensions.cynaps_tools.core import label_config
from rest_framework.exceptions import ValidationError

from cynaps.core.utils.io import find_file
...
def parse_config(config_string):
    ...
    """
    logger.warning('Using deprecated method - switch to cynaps.tools.label_config.parse_config!')
