...
from cynaps.core.current_request import get_current_request
from cynaps.core.utils.common import load_func
from cynaps.core.utils.io import find_node
from cynaps.core.utils.params import get_all_env_with_prefix, get_bool_env
...
def get_feature_file_path():
    package_name = 'cynaps' if settings.VERSION_EDITION == 'Community' else 'cynaps_enterprise'
