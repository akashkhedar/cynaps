...
urlpatterns = [
    # SEO files - serve from views
    path('sitemap.xml', views.sitemap_xml, name='sitemap'),
    path('robots.txt', views.robots_txt, name='robots'),
    # IndexNow verification key for instant search engine indexing
    path('579a080b3263486886e7441628580d70.txt', views.indexnow_key, name='indexnow-key'),
    # PWA Manifest
    ...
    # Legal pages
    re_path(r"^privacy/$", views.main, name="privacy-policy"),
    re_path(r"^terms/$", views.main, name="terms-of-service"),
    re_path(r"^refund-policy/$", views.main, name="refund-policy"),
    ...
    path("api/contact/", views.ContactUsAPI.as_view(), name="api-contact"),
