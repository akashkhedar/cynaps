...
def parse_input_args(input_args):
    ...
    root_parser.add_argument('--version', dest='version', action='store_true', help='Show Cynaps version')
    root_parser.add_argument(
        '-b',
        '--no-browser',
        dest='no_browser',
        action='store_true',
        help='Do not open browser when starting Cynaps',
    )
    root_parser.add_argument(
    ...
    root_parser.add_argument(
        ...
        type=str,
        default='',
        help='Cynaps full hostname for generating imported task urls, sample task urls, static loading, etc.\n'
    ...
    parser = argparse.ArgumentParser(description='Cynaps', parents=[root_parser])
    ...
    parser_init = subparsers.add_parser('init', help='Initialize Cynaps', parents=[root_parser])
    ...
    parser_start = subparsers.add_parser('start', help='Start Cynaps server', parents=[root_parser])
