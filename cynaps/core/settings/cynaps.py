...
# In dev mode, use standard static files backend (no manifest required)
if DEBUG:
    STORAGES = {
        "default": {
...
from cynaps.core.utils import sentry

sentry.init_sentry(release_name="cynaps", release_version=__version__)
...
# in Cynaps Community version, feature flags are always ON
...
try:
    ...
    find_node("cynaps", FEATURE_FLAGS_FILE, "file")
except IOError:
