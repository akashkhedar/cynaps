...
from cynaps.io_storages.functions import get_storage_by_url
from cynaps.io_storages.utils import parse_range
...
class ResolveStorageUriAPIMixin:
    def resolve(self, request: HttpRequest, fileuri: str, instance: Union[Task, Project]) -> Response:
        ...
        # and all files are proxied through Cynaps using Cynaps auth and RBAC control.
...
class TaskResolveStorageUri(ResolveStorageUriAPIMixin, APIView):
    ...
    If the storage has presign=False, it will proxy the data through Cynaps
    ...
    def get(self, request, *args, **kwargs):
        """Get the presigned url for a given fileuri or proxy data through Cynaps"""
