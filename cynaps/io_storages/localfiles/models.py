...
class LocalFilesMixin(models.Model):
    ...
    def community_auto_hint():
        if settings.VERSION_EDITION == 'Community':
            return (
                ' Community tip: create a "mydata" or "cynaps-data" directory next to Cynaps '
    ...
    def validate_connection(self):
        ...
        if settings.LOCAL_FILES_SERVING_ENABLED is False:
            raise ValidationError(
                ...
                'variable to "true" and restart Cynaps. See '
                'https://cynaps.xyz/guide/storage.html#Local-storage for details.'
                '\n\n'
