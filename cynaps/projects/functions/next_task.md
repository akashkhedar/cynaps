...
This doc summarizes how Cynaps Enterprise selects the next task for labeling, based on the current code in `cynaps/projects/functions/next_task.py` and LSE-specific logic from `cynaps_enterprise/lse_projects/functions.py`.
...
## References
- Core selection: `cynaps/projects/functions/next_task.py`
- LSE agreement & counters: `cynaps_enterprise/lse_projects/functions.py`
