...
def test_action_cache_labels(business_client, project_id):
    ...
    assert tasks.get(id=task2.id).data.get('cache_label1') == 'Left Lung: 1, Car: 2', 'cache_label1 wrong for task 2'
    ...
    assert tasks.get(id=task2.id).data.get('cache_label1') == 'Left Lung, Car', 'cache_label1 wrong for task 2'
