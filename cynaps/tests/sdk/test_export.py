...
async def test_project_async(django_live_url, business_client):
    Cynaps = AsyncCynaps(base_url=django_live_url, api_key=business_client.api_key)
...
@pytest.mark.skip(reason='pytest-asyncio is not supported in this version of Cynaps')
