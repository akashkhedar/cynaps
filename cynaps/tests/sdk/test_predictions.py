...
from cynaps.tests.sdk.common import LABEL_CONFIG_AND_TASKS

pytestmark = pytest.mark.django_db
from cynaps_sdk.client import cynaps
from cynaps_sdk.cynaps_interface import LabelInterface
from cynaps_sdk.cynaps_interface.objects import PredictionValue, TaskValue


def test_predictions_CRUD(django_live_url, business_client):
    client = Cynaps(base_url=django_live_url, api_key=business_client.api_key)
...
def test_create_predictions_with_import(django_live_url, business_client):
    ...
    client.projects.import_tasks(
        ...
        request=[
            ...
            {'my_text': 'Goodbye Cynaps', 'sentiment_class': 'Negative'},
    ...
    # assert it raises CYNAPS_sdk.core.api_error.ApiError with validation_errors': {'model_version': ["Model version doesn't exist..." ]}
