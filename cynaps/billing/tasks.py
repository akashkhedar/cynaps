    ...
    for billing in low_credit_orgs:
        try:
            ...
            logger.info(
                ...
                f"{billing.available_credits} Credits remaining"
            )
    ...
    for pb in upcoming_charges:
        try:
            ...
            logger.info(
                ...
                f"{retention_fee} Credits for storage retention on {pb.next_retention_charge_at}"
            )
            ...
            if org_billing.available_credits >= retention_fee:
                ...
                if result["success"]:
                    ...
                    logger.info(
                        ...
                        f"{result['charged']} Credits charged for month {pb.months_retained}"
                    )
            else:
                ...
                if pb.insufficient_credits_warned_at is None:
                    ...
                    logger.warning(
                        ...
                        f"Required: {retention_fee} Credits, Available: {org_billing.available_credits} Credits. "
