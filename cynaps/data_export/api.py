...
class ExportAPI(generics.RetrieveAPIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        # Credits deduction bypassed as requested
        # try:
        ...
        logger.info(f"Export credit deduction bypassed for {task_count} tasks.")
        ...
        try:
            ...
            logger.info(
                ...
                f"{payment_result['total_released']} Credits total for project {project.id}"
            )
        except Exception as e:
...
#         description="""
#         Retrieve a list of files exported from Cynaps UI using the Export button on the Data Manager page.
...
class ExportListAPI(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        #         )
        logger.info(f"Export snapshot credit deduction bypassed for {task_count} tasks.")
