...
for plan in all_plans:
    ...
    print(f"{status:12} | {plan.name:30} | {plan.price_inr:>10,.0f} Credits | {plan.credits_per_month:>8,} credits")
...
for pkg in all_packages:
    ...
    print(f"{status:12} | {pkg.name:30} | {pkg.price_inr:>10,.0f} Credits | {pkg.credits:>8,} credits")
