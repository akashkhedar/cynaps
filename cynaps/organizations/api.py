...
from cynaps.core.permissions import ViewClassPermission, all_permissions
from cynaps.core.utils.params import bool_from_request
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description='Get a link to use to invite a new member to an organization in Cynaps Enterprise.',
