...
class Task(TaskMixin, FsmHistoryStateModel):
    ...
    data = JSONField(
        ...
        "on the Import page in Cynaps Data Manager UI.",
    )
    ...
    def has_lock(self, user=None):
        ...
        if self.project.show_ground_truth_first:
            ...
            # https://Cynaps.atlassian.net/browse/LEAP-1963
...
class Prediction(models.Model):
    ...
    def create_no_commit(
        ...
        try:
            ...
            # given the data receive, create annotation regions in Cynaps format
