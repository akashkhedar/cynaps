...
@method_decorator(
    ...
    decorator=(
        extend_schema(
            tags=["Tasks"],
            summary="Create task",
            description="Create a new labeling task in Cynaps.",
            request={
    ...
    """,
            parameters=[
                ...
                OpenApiParameter(
                    ...
                    "[Read more about available filters](https://cynaps.xyz/sdk/data_manager.html)<br/>"
...
@method_decorator(
    ...
    decorator=extend_schema(
        tags=["Tasks"],
        summary="Delete task",
        description="Delete a task in Cynaps. This action cannot be undone!",
        parameters=[
            OpenApiParameter(
                name="id", type=OpenApiTypes.STR, location="path", description="Task ID"
            ),
