# Cynaps Platform Overview

> Last Updated: February 18, 2026

## Executive Summary

**Cynaps** is an enterprise-grade data annotation platform designed for machine learning teams. It provides comprehensive tools for labeling various types of data including images, text, audio, video, time-series data, and documents. The platform combines a powerful XML-configurable annotation interface with a managed workforce of trained annotators, sophisticated quality assurance mechanisms (honeypot system v2.0, consensus engine, expert review), and seamless ML pipeline integration via REST API and Python SDK.

### Key Differentiators

- **Credits-Based Marketplace Model**: Connect enterprises with a trained annotator workforce
- **Honeypot Quality System v2.0**: System-controlled quality monitoring with automatic accuracy tracking and tiered warnings
- **Multi-Annotator Consensus**: Configurable overlap (1-3 annotators) with intelligent conflict resolution
- **Trust Level Progression**: Gamified annotator growth from New → Junior → Regular → Senior → Expert
- **Flexible Billing**: Pay-as-you-go credits or subscription plans (Starter/Growth/Scale)
- **Storage Integration**: Native support for AWS S3, Google Cloud Storage, Azure Blob, and local filesystem
...
```
cynaps-develop/
├── cynaps/              # Django Backend (Core Platform)
...
│   ├── apps/
│   │   ├── cynaps/      # Main React application
│   │   ├── playground/   # Component development playground
│   │   └── cynaps-e2e/  # End-to-end tests
│   └── libs/
...
│
├── cynaps-sdk/          # Python SDK for API integration
│
...
### 2. Annotation Editor (Cynaps Frontend)
...
client = Cynaps(api_key="sk_live_xxx")
...
1. Sign up at `https://app.cynaps.io`
