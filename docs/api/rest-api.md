...
```
Production: https://api.cynaps.io/v1
Staging:    https://staging-api.cynaps.io/v1
```
...
curl -H "Authorization: Token sk_live_xxxx" \
     https://api.cynaps.io/v1/projects

# Query parameter (not recommended)
curl https://api.cynaps.io/v1/projects?api_key=sk_live_xxxx
```
...
```bash
curl -X POST https://api.cynaps.io/v1/projects \
...
```json
{
  "data": {
    ...
    "status": "ready",
    "format": "coco",
    "download_url": "https://cynaps.io/exports/exp_abc123/download",
...
```json
{
  "data": {
    "payment_id": "pay_abc123",
    "status": "pending",
    "checkout_url": "https://cynaps.io/checkout/pay_abc123",
    "amount": 1500.00
  }
}
```
