  ...
  describe("PlaygroundApp: Loads configs from v1 URL", () => {
    it.each([
      ...
      },
      {
        ...
        url: "https://localhost?config=%3CView%3E%3Cbr%3E%20%20%3CImage%20name%3D%22image%22%20value%3D%22%24image%22%2F%3E%3Cbr%3E%20%20%3CRectangleLabels%20name%3D%22label%22%20toName%3D%22image%22%3E%3Cbr%3E%20%20%20%20%3CLabel%20value%3D%22Left Lung%22%20background%3D%22green%22%2F%3E%3Cbr%3E%20%20%20%20%3CLabel%20value%3D%22Car%22%20background%3D%22blue%22%2F%3E%3Cbr%3E%20%20%3C%2FRectangleLabels%3E%3Cbr%3E%3C%2FView%3E%3Cbr%3E",
        expectedConfig: `<View>
      <Image name=\"image\" value=\"$image\"/>
      <RectangleLabels name=\"label\" toName=\"image\">
        <Label value=\"Left Lung\" background=\"green\"/>
      ...
      },
      {
        ...
        url: "https://localhost?config=%3CView%3E%3Cbr%3E%20%20%3CImage%20name%3D%22image%22%20value%3D%22%24image%22%2F%3E%3Cbr%3E%20%20%3CEllipseLabels%20name%3D%22tag%22%20toName%3D%22image%22%3E%3Cbr%3E%20%20%20%20%3CLabel%20value%3D%22Left Lung%22%20background%3D%22green%22%2F%3E%3Cbr%3E%20%20%20%20%3CLabel%20value%3D%22Car%22%20background%3D%22blue%22%2F%3E%3Cbr%3E%20%20%3C%2FEllipseLabels%3E%3Cbr%3E%3C%2FView%3E%3Cbr%3E",
        expectedConfig: `<View>
      <Image name=\"image\" value=\"$image\"/>
      ...
      <PolygonLabels name=\"label\" toName=\"image\"
                     ...
                     opacity=\"0.9\">
        <Label value=\"Left Lung\" background=\"red\"/>
        <Label value=\"Car\" background=\"blue\"/>
      </PolygonLabels>·
    </View>`,
      },
      {
        name: "Annotation templates: Multi-class classification",
      ...
      },
      {
        ...
        expectedConfig: `<View>
      <Header value=\"Note: To manage relations you need Cynaps entity panel to be shown\" />·
      <Relations>
        <Relation value=\"Is A\" />
