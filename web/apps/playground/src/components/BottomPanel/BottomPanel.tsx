...
import { IconCollapseSmall, IconExpandSmall } from "@cynaps/icons";
import { cnm } from "@cynaps/ui/utils/utils";
    ...
    >
      ...
      >
        ...
        <button
          ...
          className="CF-button CF-button_look_ CF-collapsible-bottom-panel-toggle absolute right-[5px] top-1/2 -translate-y-1/2 !h-6 !w-6 !p-0 flex items-center justify-center !bg-transparent !border-none"
          style={{ zIndex: 10 }}
        >
