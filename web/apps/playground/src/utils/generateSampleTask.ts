...
const SAMPLE_WEBSITE = "<a href='https://cynaps.io'>https://cynaps.io</a>";
const SAMPLE_PDF_EMBED = "<embed src='https://app.heartex.ai/static/samples/sample.pdf' width='100%' height='600px'/>";
const SAMPLE_WEBSITE_EMBED = "<iframe src='https://cynaps.io' width='100%' height='600px'/>";
...
// Utility to generate a sample task from a Cynaps XML config
