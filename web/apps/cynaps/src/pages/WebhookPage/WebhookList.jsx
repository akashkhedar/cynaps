import { IconCross, IconExternal, IconPencil, IconWebhook } from "@cynaps/icons";
import { Button, EmptyState, SimpleCard, Typography } from "@cynaps/ui";
...
import { ABILITY, useAuth } from "@cynaps/core/providers/AuthProvider";
          ...
          {webhooks.length === 0 ? (
            <>
              <div className="settings-description mb-6">
                ...
                event is triggered, Cynaps sends an HTTP POST request to the
                configured URL.
              </div>
