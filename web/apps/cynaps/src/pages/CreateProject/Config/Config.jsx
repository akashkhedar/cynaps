...
import { Button, cnm } from "@cynaps/ui";
import { IconTrash } from "@cynaps/icons";
...
import { Checkbox, CodeEditor, Select } from "@cynaps/ui";
...
const EmptyConfigPlaceholder = () => (
  <div className={configClass.elem("empty-config")}>
    ...
    <p>
      ...
      <a href="https://cynaps.io/tags/" target="_blank" rel="noreferrer">
    ...
    <div className={configClass.elem("labels")}>
      <form className={configClass.elem("add-labels")} action="">
        ...
        <textarea
          ...
          className="CF-textarea-ls p-2 px-3"
        />
        <button
          type="button"
          size="small"
