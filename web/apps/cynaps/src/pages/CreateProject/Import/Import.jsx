import { SampleDatasetSelect } from "@cynaps/app-common/blocks/SampleDatasetSelect/SampleDatasetSelect";
import { ff, formatFileSize } from "@cynaps/core";
import { IconCode, IconErrorAlt, IconFileUpload, IconInfoOutline, IconTrash, IconUpload } from "@cynaps/icons";
import { Badge } from "@cynaps/shad/components/ui/badge";
import { cn as scn } from "@cynaps/shad/utils";
...
import "./Import.scss";
import { Button, CodeBlock, SimpleCard, Spinner, Tooltip, Typography } from "@cynaps/ui";
                      ...
                      <dt>
                        <div className="flex items-center gap-1">
                          ...
                          <Tooltip title="Video format support depends on your browser. Click to learn more.">
                            <a
                              href="https://cynaps.io/tags/video#Video-format"
                              target="_blank"
