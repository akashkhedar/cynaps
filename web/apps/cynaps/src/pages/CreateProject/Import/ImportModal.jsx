...
import { Button, Spinner } from "@cynaps/ui";
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                  ...
                  <span style={{
                    ...
                    Base fee increased from {Math.round(costInfo.breakdown?.original_base_fee || 500)} Credits to {Math.round(costInfo.breakdown?.new_base_fee || 500)} Credits
                  </span>
                </div>
                <span style={{
                  fontWeight: 600,
