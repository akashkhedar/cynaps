...
import { Button, Typography, Spinner } from "@cynaps/ui";
      ...
      {calculating ? (
        <div className="security-deposit__loading" style={{
          ...
          <span style={{
            ...
            letterSpacing: '0.1em',
            fontFamily: 'ui-monospace, SFMono-Regular, "CF Mono", Menlo, Consolas, monospace'
          }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                {depositInfo.breakdown?.storage_overage_gb > 0 && (
                  <span style={{
                    ...
                    {depositInfo.breakdown?.free_storage_gb > 0 && (
                      <> • {depositInfo.breakdown?.free_storage_gb?.toFixed(0)} GB free • {depositInfo.breakdown?.storage_overage_gb?.toFixed(1)} GB overage @ {depositInfo.breakdown?.storage_rate?.toFixed(0)} Credits/GB</>
                    )}
                  </span>
                )}
                {depositInfo.breakdown?.storage_overage_gb === 0 && (
                ...
                {depositInfo.breakdown?.storage_fee > 0 && (
                  <span style={{
                    ...
                    Monthly retention: {depositInfo.breakdown?.storage_rate?.toFixed(0)} Credits/GB for overage storage
                  </span>
                )}
              </div>
              <span style={{
