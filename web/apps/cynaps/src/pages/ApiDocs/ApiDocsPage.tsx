...
const sdkSections: SDKSection[] = [
  {
    id: "installation",
    name: "Installation",
    description: "Install the Cynaps Python SDK to get started",
    icon: <InstallIcon />,
    methods: [
      {
        name: "pip install",
        signature: "pip install cynaps-sdk",
        description: "Install the Cynaps SDK using pip package manager.",
        example: {
          language: "bash",
...
# Verify installation
python -c "from cynaps_sdk import Cynaps; print('SDK installed!')"`
        }
      }
    ]
  },
  {
    id: "client",
    name: "Client",
    description: "Initialize the Cynaps client with your API key",
    icon: <ClientIcon />,
    methods: [
      {
        name: "Cynaps",
        signature: "Cynaps(api_key: str, base_url: str = None)",
        description: "Create a new Cynaps client instance. The API key can be obtained from Settings > API Keys.",
        parameters: [
          { name: "api_key", type: "str", required: true, description: "Your Cynaps API key" },
          { name: "base_url", type: "str", required: false, description: "API base URL (default: https://app.cynaps.io)" },
          { name: "timeout", type: "float", required: false, description: "Request timeout in seconds (default: 60)" },
        ],
        returns: "Cynaps client instance",
        example: {
          language: "python",
          code: `from cynaps_sdk import Cynaps

# Initialize with API key
client = Cynaps(api_key="your-api-key")
    ...
    methods: [
      {
        ...
        parameters: [
          ...
          { name: "label_config", type: "str", required: false, description: "XML label configuration (Cynaps format)" },
...
for page in client.projects.list().iter_pages():
    for project in page:
      ...
      },
      {
        ...
        description: "Retrieve a specific project by ID. Returns extended project with cynaps interface access.",
        parameters: [
...
interface = project.get_cynaps_interface()
...
const QuickStartWorkflow = () => {
  const workflowCode = `import cynaps
...
const ExportFormatsSection = () => {
  const formats = [
    { format: "json", description: "Cynaps JSON format", useCase: "General purpose" },
    ...
    <div className="api-docs-page">
      ...
      <section className="api-hero">
        ...
        <div className="hero-content">
          ...
          >
            Integrate Cynaps annotations directly into your ML training pipelines.
            ...
            <section className="auth-section">
              ...
              <div className="auth-content">
                ...
                <div className="auth-example">
                  <code>export CYNAPS_API_KEY=sk_live_xxxx</code>
                  <CopyButton text="export CYNAPS_API_KEY=sk_live_xxxx" />
                </div>
