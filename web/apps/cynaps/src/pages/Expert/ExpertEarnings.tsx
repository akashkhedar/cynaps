        ...
        >
          <div className="balance-card available">
            ...
            <div className="balance-value">
              {<CreditsDisplay amount={summary?.available_balance || 0} />}
            </div>
          ...
          <div className="balance-card pending">
            ...
            <div className="balance-value">
              {<CreditsDisplay amount={summary?.pending_payout || 0} />}
            </div>
          ...
          <div className="balance-card total">
            ...
            <div className="balance-value">
              {<CreditsDisplay amount={summary?.total_earned || 0} />}
            </div>
          ...
          <div className="balance-card withdrawn">
            ...
            <div className="balance-value">
              {<CreditsDisplay amount={summary?.total_withdrawn || 0} />}
            </div>
          ...
          <div className="stats-grid">
            ...
            <div className="stat-item">
              <span className="stat-value accent">
                {<CreditsDisplay amount={summary?.weekly_earnings || 0} />}
              </span>
              <span className="stat-label">This Week</span>
            </div>
            <div className="stat-item">
              <span className="stat-value accent">
                {<CreditsDisplay amount={summary?.monthly_earnings || 0} />}
              </span>
          ...
          >
            ...
            <div className="info-grid">
              ...
              <div className="info-item">
                ...
                <div className="info-content">
                  <h4>Payouts</h4>
                  <p>Request when balance exceeds 500 Credits</p>
                </div>
              </div>
            </div>
          </motion.section>
                ...
                summary.recent_transactions.map((tx) => (
                  <div key={tx.id} className="transaction-item">
                    ...
                    <div className="tx-right">
                      ...
                      >
                        {tx.amount >= 0 ? "+" : ""}
                        {<CreditsDisplay amount={tx.amount} />}
                      </span>
