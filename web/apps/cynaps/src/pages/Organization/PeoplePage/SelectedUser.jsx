    ...
    <div className={cn("user-info").toClassName()}>
      ...
      <Modal
        ...
        footer={
          <>
            <button
              className="cy-button cy-button_look_secondary"
            ...
            <button
              className="cy-button cy-button_look_primary"
      ...
      <Modal
        ...
        footer={
          <>
            ...
            <button
              className="cy-button cy-button_look_danger"
