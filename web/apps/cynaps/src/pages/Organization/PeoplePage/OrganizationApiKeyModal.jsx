...
import { IconCopy, IconRefresh, IconCheck, IconCross, IconEyeOpened, IconEyeClosed } from "@cynaps/icons";
...
export const OrganizationApiKeyModal = ({ organizationId, onClose, onSaved }) => {
  ...
  const keyValueStyle = {
    ...
    color: "#ffffff",
    fontFamily: "ui-monospace, 'CF Mono', 'Cascadia Code', Consolas, monospace",
    fontSize: "13px",
    overflowX: "auto",
    overflowY: "hidden",
    whiteSpace: "nowrap",
            ...
            <>
              ...
              {createdAt && (
                <div style={metaStyle}>
                  ...
                  <span style={{ color: "#d1d5db", fontFamily: "ui-monospace, 'CF Mono', Consolas, monospace", fontSize: "12px" }}>
              ...
              <div style={codeBlockStyle}>
                ...
                >
                  <code style={{ 
                    ...
                    cynaps.init(api_key="{isRevealed ? apiKey : 'YOUR_API_KEY'}")
                  </code>
                </div>
              </div>
