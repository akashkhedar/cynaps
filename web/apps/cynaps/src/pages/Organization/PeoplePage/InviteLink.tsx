import { Button, Typography } from "@cynaps/ui";
import { Space } from "@cynaps/ui/lib/space/space";
import { cn } from "apps/cynaps/src/utils/bem";
import { Modal } from "apps/cynaps/src/components/Modal/ModalPopup";
import { API } from "apps/cynaps/src/providers/ApiProvider";
  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        Invite members to join your Cynaps instance. People that you invite have full access to all of your
        projects.{" "}
        <a
          href="https://cynaps.io/guide/signup.html"
          target="_blank"
          rel="noreferrer"
          style={{
            color: '#c4b5fd',
