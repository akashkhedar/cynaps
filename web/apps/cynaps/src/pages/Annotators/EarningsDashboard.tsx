...
import { Button, useToast, ToastType, Spinner } from "@cynaps/ui";
...
/**
 * Formats a number for display as Credits, without the "cr" suffix.
 */
const formatCreditsNum = (amount: number): string => {
...
/**
 * Format a number as Credits (platform currency).
 * No currency symbols — just plain number + "Credits".
 */
const CreditsDisplay: React.FC<{ amount: number; prefix?: string }> = ({
  amount,
  prefix = "",
}) => (
  <>
    {prefix}
    {formatCreditsNum(amount)}{" "}
    <span style={{
      fontSize: "0.5em",
      fontWeight: 400,
      opacity: 0.55,
        ...
        >
          <div className="stat-card available">
            ...
            <div className="stat-value primary">
              <CreditsDisplay amount={summary.available_balance} />
            </div>
            <div className="stat-hint">Ready to use</div>
          </div>
          <div className="stat-card">
            <div className="stat-label">PENDING</div>
            <div className="stat-value">
              <CreditsDisplay amount={summary.pending_approval} />
            </div>
          ...
          <div className="stat-card">
            ...
            <div className="stat-value">
              <CreditsDisplay amount={summary.total_earned} />
            </div>
            <div className="stat-hint">Lifetime credits</div>
          </div>
          <div className="stat-card">
                      ...
                      >
                        ...
                        <div className="bar-tooltip">
                          ...
                          <span className="tooltip-amount">
                            <CreditsDisplay amount={bar.amount} />
                          </span>
                        </div>
                        <motion.div
                          className={`bar ${
                ...
                <div className="chart-summary">
                  <div className="summary-item">
                    ...
                    <span className="summary-value">
                      <CreditsDisplay amount={summary.weekly_earnings} />
                    </span>
                  </div>
                  <div className="summary-item">
                    <span className="summary-label">THIS MONTH</span>
                    <span className="summary-value">
                      <CreditsDisplay amount={summary.monthly_earnings} />
                    </span>
                  </div>
                  <div className="summary-item">
                    <span className="summary-label">DAILY AVG</span>
                    <span className="summary-value accent">
                      <CreditsDisplay amount={chartData.avg} />
                    </span>
                  </div>
                </div>
              </div>
                ...
                {summary.recent_transactions.length === 0 ? (
                  ...
                  summary.recent_transactions.slice(0, 5).map((tx) => (
                    <div key={tx.id} className="tx-row">
                      ...
                      >
                        <CreditsDisplay amount={tx.amount} prefix={tx.amount >= 0 ? "+" : ""} />
                      </span>
                    </div>
                  ))
                )}
