...
const LineChart: React.FC<{
  ...
  const xScale = (index: number) => {
    return (
      padding.left +
      (index / (data.length - 1 || 1)) * (width - padding.left - padding.right)
    );
  };
          ...
          >
            <div
              style={{
                ...
                borderRadius: "50%",
                background:
                  hoveredPoint.type === "credit" ? "#10b981" : "#ef4444",
...
export const CreditDashboard: React.FC = () => {
  ...
  const CreditsDisplay: React.FC<{ amount: number }> = ({ amount }) => (
    <>
  ...
  const getTransactionIcon = (type: string, category: string) => {
    if (type === "credit") {
      if (category === "purchase" || category === "subscription")
        return <CardIcon />;
        ...
        <div className="balance-card primary">
          ...
          <div className="card-content">
            ...
            <div className="card-value">
              {billing.available_credits.toLocaleString()}
            </div>
        ...
        <div className="subscription-info">
          ...
          <div className="info-grid">
            ...
            <div className="info-item">
              ...
              <span className="value">
                {formatDate(
                  billing.active_subscription_details.next_billing_date,
                )}
              </span>
            </div>
            <div className="info-item">
              ...
              <span className="value">
                {billing.active_subscription_details.auto_renew
                  ? "Enabled"
                  : "Disabled"}
              </span>
            </div>
                      ...
                      <div key={payment.id} className="payment-item">
                        ...
                        <div className="payment-right">
                          <div className="payment-amount">
                            <CreditsDisplay amount={payment.amount_inr} />
                          </div>
                    ...
                    <tbody>
                      {recent_transactions.map((txn) => (
                        <tr key={txn.id}>
                          ...
                          <td>
                            <span
                              className={`type-badge ${txn.transaction_type}`}
                            >
                              {txn.transaction_type}
                            </span>
                          </td>
