...
import { Button, Typography, useToast } from "@cynaps/ui";
import { useUpdatePageTitle, createTitleFromSegments } from "@cynaps/core";
                  ...
                  <div className="deletion-summary">
                    ...
                    {summary.refund_estimate > 0 && (
                      <div className="summary-stat refund">
                        <span className="stat-value">
                          {summary.refund_estimate.toFixed(0)} Credits
                        </span>
                    ...
                    <div className="breakdown-table">
                      <div className="breakdown-row">
                        ...
                        <span className="breakdown-value">
                          {refundBreakdown.deposit_paid.toFixed(0)} Credits
                        </span>
                      </div>
                      ...
                      {refundBreakdown.base_fee_refund > 0 && (
                        <div className="breakdown-row refund">
                          ...
                          <span className="breakdown-value" style={{ color: "#4ade80" }}>
                            + {refundBreakdown.base_fee_refund.toFixed(0)} Credits
                          </span>
                        </div>
                      )}
                      ...
                      {refundBreakdown.buffer_refund > 0 && (
                        <div className="breakdown-row refund">
                          ...
                          <span className="breakdown-value" style={{ color: "#4ade80" }}>
                            + {refundBreakdown.buffer_refund.toFixed(0)} Credits
                          </span>
                        </div>
                      )}
                      ...
                      {refundBreakdown.unannotated_tasks_refund > 0 && (
                        <div className="breakdown-row refund">
                          ...
                          <span className="breakdown-value" style={{ color: "#4ade80" }}>
                            + {refundBreakdown.unannotated_tasks_refund.toFixed(0)} Credits
                          </span>
                        </div>
                      )}
                      ...
                      {refundBreakdown.annotation_cost > 0 && (
                        <div className="breakdown-row deduction">
                          ...
                          <span className="breakdown-value">
                            - {refundBreakdown.annotation_cost.toFixed(0)} Credits
                          </span>
                        </div>
                      )}
                      {refundBreakdown.credits_consumed > 0 && (
                        <div className="breakdown-row deduction">
                          ...
                          <span className="breakdown-value">
                            - {refundBreakdown.credits_consumed.toFixed(0)} Credits
                          </span>
                        </div>
                      )}
                      <div className="breakdown-row total">
                        ...
                        <span className="breakdown-value refund-amount">
                          {refundBreakdown.refund_amount.toFixed(0)} Credits
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                if (refundAmount > 0) {
                  ...
                  if (consumed > 0) {
                    successMessage += ` (${consumed.toFixed(
                      0
                    )} credits were consumed for annotations)`;
                  }
                } else if (consumed > 0) {
