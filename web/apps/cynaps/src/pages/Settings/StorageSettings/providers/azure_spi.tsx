...
import { IconCloudProviderAzure } from "@cynaps/icons";
  ...
  fields: [
    {
      ...
      content: (
        <Alert variant="gradient">
          ...
          <AlertDescription>
            Azure Blob Storage with Service Principal is available in Cynaps Enterprise.{" "}
            <a
              href="https://docs.Cynaps.com/guide/storage.html#Azure-Blob-Storage-with-Service-Principal-authentication"
              target="_blank"
