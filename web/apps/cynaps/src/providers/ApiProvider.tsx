...
// Initialize API instance with Cynaps configuration
...
export { useAPI, ApiContext } from "@cynaps/core";
...
/**
 * Cynaps application-specific ApiProvider.
 * Wraps the core ApiProvider with Cynaps-specific error handling.
 */
...
>(({ children }, ref) => {
  ...
  /**
   * Handles errors with Cynaps-specific logic including:
