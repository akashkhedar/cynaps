...
const testimonials = [
  {
    quote:
      "Cynaps has transformed how we label data for our computer vision models. The collaborative features are game-changing.",
    author: "Sarah Chen",
    role: "ML Engineer",
  ...
  {
    quote:
      "We moved from a commercial solution to Cynaps and never looked back. It's more flexible and the open-source community is amazing.",
