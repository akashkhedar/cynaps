import { Typography } from "@cynaps/ui";
...
const footerLinks = {
  ...
  resources: [
    { label: "Blog", href: "https://cynaps.io/blog/", external: true },
    { label: "Community", href: "https://slack.cynaps.io", external: true },
    {
      label: "GitHub",
      href: "https://github.com/Cynaps/cynaps",
      external: true,
    },
    { label: "Tutorials", href: "/tutorials/" },
    {
      label: "Video Guides",
      href: "https://youtube.com/@Cynaps",
      external: true,
    },
  ],
  company: [
  ...
  legal: [
    ...
    {
      label: "License",
      href: "https://github.com/Cynaps/cynaps/blob/master/LICENSE",
      external: true,
    },
  ],
};
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="border-t border-neutral-border pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <Typography className="text-sm text-neutral-content-subtler">
            © {new Date().getFullYear()} Cynaps. Open source under Apache 2.0
            License.
          </Typography>
