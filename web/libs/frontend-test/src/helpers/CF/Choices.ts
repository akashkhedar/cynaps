class ChoicesHelper {
  ...
  private getСhoiceSelector() {
    return ".cf-choice__item .ant-checkbox + span, .cf-choice__item .ant-radio + span";
  }

  private getCheckedСhoiceSelector() {
    return ".cf-choice__item .ant-checkbox-checked + span, .cf-choice__item .ant-radio-checked + span";
  }
