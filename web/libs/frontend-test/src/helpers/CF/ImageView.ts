...
export const ImageView = {
  ...
  get root() {
    return this.image.closest(".cf-object");
  },
  get drawingFrame() {
  ...
  get toolBar() {
    cy.log("Get tool bar");
    return this.root.find(".cf-toolbar");
  },
  get pagination() {
    return this.root.get('[class^="pagination--"]');
  },
  get paginationPrevBtn() {
    return this.pagination.get(".cf-pagination__btn_arrow-left:not(.cf-pagination__btn_arrow-left-double)");
  },
  get paginationNextBtn() {
    return this.pagination.get(".cf-pagination__btn_arrow-right:not(.cf-pagination__btn_arrow-right-double)");
  },
  waitForImage() {
  ...
  selectRectangleToolByButton() {
    this.toolBar
      ...
      .should("be.visible")
      .click()
      .should("have.class", "CF-tool_active");
  },
  ...
  selectPolygonToolByButton() {
    this.toolBar.find('[aria-label="polygon-tool"]').should("be.visible").click().should("have.class", "CF-tool");
  },
  ...
  selectBrushToolByButton() {
    this.toolBar.find('[aria-label="brush-tool"]').should("be.visible").click().should("have.class", "CF-tool_active");
  },

  selectMoveToolByButton() {
    this.toolBar.find('[aria-label="move-tool"]').should("be.visible").click().should("have.class", "CF-tool_active");
  },
