...
class VideoViewHelper extends withMedia(
  class implements ViewWithMedia {
    ...
    get videoCanvas() {
      return this.root.get(".cf-video-canvas");
    }

    get framesControl() {
      return this.root.find(".cf-frames-control");
    }

    get timelineContainer() {
      return this.root.get(".cf-video-segmentation__timeline");
    }

    get timelineToolbar() {
      return this.root.get(".cf-timeline__topbar");
    }

    get timeLine() {
      return this.timelineToolbar.find(".cf-seeker");
    }
    get frameCounter() {
      return this.timelineToolbar.get(".cf-frames-control");
    }
    ...
    get timeLineLabels() {
      return this.root.get(".cf-timeline-frames__labels-bg");
    }

    get timeframesArea() {
      return this.root.get(".cf-timeline-frames__scroll");
    }
    ...
    drawRect(x: number, y: number, width: number, height: number, options: MouseInteractionOptions = {}) {
      ...
      this.drawingArea
        ...
        // This problem could be solved in VideoRegions component of CF
    ...
    captureCanvas(name: string) {
      return this.drawingArea.captureScreenshot(name, { withHidden: [".cf-video-canvas"] });
    }
    ...
    canvasShouldChange(name: string, threshold = 0.1) {
      return this.drawingArea.compareScreenshot(name, "shouldChange", { withHidden: [".cf-video-canvas"], threshold });
    }
