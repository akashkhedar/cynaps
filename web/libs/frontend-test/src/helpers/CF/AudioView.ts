...
import { withMedia } from "@cynaps/frontend-test/helpers/utils/media/MediaMixin";
import { Cynaps } from "@cynaps/frontend-test/helpers/CF/Cynaps";
import type { ViewWithMedia } from "@cynaps/frontend-test/helpers/utils/media/types";
...
class AudioViewHelper extends withMedia(
  class implements ViewWithMedia {
    ...
    get timelineControls() {
      return this.root.find(".cf-timeline-controls");
    }

    get currentTimebox() {
      return this.timelineControls.find('[data-testid="timebox-current-time"] > .cf-time-box__input-time');
    }

    get endTimebox() {
      return this.timelineControls.find('[data-testid="timebox-end-time"] > .cf-time-box__input-time');
    }

    get configButton() {
      return this.timelineControls.find(".cf-audio-config > [aria-label='Audio settings']");
    }
    get volumeButton() {
      return this.timelineControls.find(".cf-audio-control > .cf-button");
    }
    ...
    get volumeSlider() {
      return this.root.find(".cf-audio-slider__range");
    }

    get volumeInput() {
      return this.root.find(".cf-audio-slider__input");
    }

    get muteButton() {
      return this.root.find(".cf-audio-control__mute-button");
    }

    get playbackSpeedSlider() {
      return cy.get(
        ".cf-audio-config__modal > .cf-audio-config__scroll-content > .cf-audio-slider:nth-child(2) .cf-audio-slider__range",
      );
    }

    get playbackSpeedInput() {
      return cy.get(
        ".cf-audio-config__modal > .cf-audio-config__scroll-content > .cf-audio-slider:nth-child(2) .cf-audio-slider__input",
      );
    }

    get amplitudeSlider() {
      return cy.get(
        ".cf-audio-config__modal > .cf-audio-config__scroll-content > .cf-audio-slider:nth-child(3) .cf-audio-slider__range",
      );
    }

    get amplitudeInput() {
      return cy.get(
        ".cf-audio-config__modal > .cf-audio-config__scroll-content > .cf-audio-slider:nth-child(3) .cf-audio-slider__input",
      );
    }

    get hideTimelineButton() {
      return this.root.get(".cf-audio-config__buttons > .cf-audio-config__menu-button:nth-child(1)");
    }

    get hideWaveformButton() {
      return this.root.get(".cf-audio-config__buttons > .cf-audio-config__menu-button:nth-child(2)");
    }
