...
Scenario("Basic details", async ({ I, Cynaps, AtOutliner, AtDetails }) => {
...
`,
  ...
  const isRelativeCoords = await Cynaps.hasFF("fflag_fix_front_dev_3793_relative_coords_short");
  ...
  const resultWithMeta = await Cynaps.serialize();
