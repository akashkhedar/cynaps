...
Data(shapesTable).Scenario("Rotate zoomed", async ({ I, Cynaps, AtImageView, AtOutliner, AtPanels, current }) => {
  const params = {
...
Data(layoutVariations).Scenario(
  ...
  async ({ I, Cynaps, AtImageView, AtOutliner, AtSettings, AtPanels, current }) => {
    I.amOnPage("/");
