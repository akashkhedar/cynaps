...
const scenarios = {
  "Works with data sorted ascending by time column": {
    ...
    assert(I) {
      ...
      I.dontSeeElement(locate(".CF-errors"));
    },
  },
...
Scenario("TimeSeries with optimized data", async ({ I, Cynaps, AtTimeSeries }) => {
