...
Scenario("Reiniting Cynaps should not left unexpected null and video tags in DOM", async ({ I, Cynaps }) => {
  I.amOnPage("/");
  for (let i = 0; i < 60; i++) {
    Cynaps.init({
      config: `
<View>
  ...
  <VideoRectangle name="box" toName="video" />
    ...
    // and fails the test with "Reiniting Cynaps should not left unexpected null and video tags in DOM:"
