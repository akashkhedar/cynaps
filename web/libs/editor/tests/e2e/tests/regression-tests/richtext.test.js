...
Scenario("Broken limits", async ({ I, Cynaps, AtOutliner }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("The selection in degenerate cases", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
...
Scenario("Exactly 1 word", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Trim spaces around the word", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Trim spaces with BRs", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Overlap checks", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Non-standard characters in words", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Should not select words from next line", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Trying to select alt attr", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
...
Scenario("Neighboring nested regions misplacement", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    annotations: [
      {
  ...
  within({ frame: ".CF-richtext__iframe" }, () => {
...

{
  ...
  Data(startBeforeEndParams).Scenario("Start before end problem", async ({ I, Cynaps, AtOutliner, current }) => {
    ...
    switch (tag.toLowerCase()) {
      ...
      case "hypertext": {
        within({ frame: ".CF-richtext__iframe" }, async () => {
          const text = await I.grabHTMLFrom(locate(".htx-highlight"));
