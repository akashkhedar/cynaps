...
Scenario("Basic Bitmask drawing", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
...
Scenario("Bitmask eraser functionality", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Bitmask size controls", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Bitmask hover and selection", async ({ I, Cynaps, AtImageView, AtLabels, AtOutliner }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask drawing content", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask pixel content", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
...
Scenario("Verify Bitmask canvas fit", async ({ I, Cynaps, AtImageView, AtLabels }) => {
  const params = {
    config,
    data: { image: IMAGE },
    annotations: [{ id: 1, result: [] }],
