...
Scenario("Drawing with ctrl pressed", async ({ I, Cynaps, AtOutliner, AtImageView, AtPanels }) => {
  const params = {
...
Scenario("How it works without ctrl", async ({ I, Cynaps, AtOutliner, AtImageView }) => {
  const params = {
