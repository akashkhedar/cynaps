...
Scenario("Check if the table is sorted", async ({ I, Cynaps, AtTableView }) => {
...
Scenario("Render JSON array of objects with derived columns", async ({ I, Cynaps }) => {
  const listConfig = `
<View>
...
Scenario("Render JSON array of primitives as key/value table", async ({ I, Cynaps }) => {
  const listKVConfig = `
<View>
