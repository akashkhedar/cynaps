...
Data(maxUsageImageToolsDataTable).Scenario(
  ...
  async ({ I, Cynaps, AtImageView, AtOutliner, AtPanels, Modals, current }) => {
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Cynaps, AtOutliner, AtAudioView, Modals, current }) => {
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Cynaps, AtOutliner, AtRichText, Modals, current }) => {
    const { maxUsage } = current;
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Cynaps, AtOutliner, AtParagraphs, current }) => {
    const { maxUsage } = current;
...
Data(maxUsageDataTable).Scenario(
  ...
  async ({ I, Cynaps, AtOutliner, AtTimeSeries, Modals, current }) => {
    const { maxUsage } = current;
