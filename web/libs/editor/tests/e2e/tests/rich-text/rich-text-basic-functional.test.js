...
Scenario("Creating, removing and restoring regions", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
...
Scenario("Region should load after change between annotation tabs", async ({ I, Cynaps }) => {
  I.amOnPage("/");
  ...
  I.click(".CF-annotation-button:nth-child(2)");
  // select first annotation
  I.click(".CF-annotation-button:nth-child(1)");
...
Scenario("Rich text content consistency", async ({ I, Cynaps, AtOutliner, AtRichText }) => {
  I.amOnPage("/");
