...
Scenario("Display correct colors", async ({ I, Cynaps, AtLabels, AtRichText }) => {
  I.amOnPage("/");
  Cynaps.init({
    config: `<View>
...
Scenario("Displaying selected and highlighted regions", async ({ I, Cynaps, AtOutliner, AtDetails }) => {
  I.amOnPage("/");
  Cynaps.init({
    config: `<View>
...
Scenario("Displaying label in the region", async ({ I, Cynaps, AtOutliner, AtSettings }) => {
