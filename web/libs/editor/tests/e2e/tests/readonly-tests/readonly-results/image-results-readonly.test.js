...
Data(imageExamples).Scenario("Image Readonly Results", async ({ I, current, Cynaps, AtOutliner, AtImageView }) => {
  I.amOnPage("/");
  ...
  await Cynaps.resultsNotChanged(result, 1);
  ...
  await Cynaps.resultsChanged(result, 1);
