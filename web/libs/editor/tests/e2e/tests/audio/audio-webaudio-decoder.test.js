...
Scenario("Check if regions are selected", async ({ I, Cynaps, AtAudioView, AtOutliner }) => {
...
Scenario("Can select a region below a hidden region", async ({ I, Cynaps, AtAudioView, AtOutliner }) => {
  Cynaps.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
...
Scenario("Delete region by pressing delete hotkey", async ({ I, Cynaps, AtAudioView, AtOutliner }) => {
  Cynaps.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
...
Scenario("Check if there are ghost regions", async ({ I, Cynaps, AtAudioView, AtOutliner }) => {
  Cynaps.setFeatureFlags({
    ff_front_dev_2715_audio_3_280722_short: true,
  });
  I.amOnPage("/");
