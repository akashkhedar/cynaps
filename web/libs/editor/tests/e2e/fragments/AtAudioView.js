...
module.exports = {
  ...
  _controlMenuSelector: ".CF-audio-control",
  _settingsMenuSelector: ".CF-audio-config",
  _volumeSliderSelector: ".CF-audio-slider__range",
  _volumeInputSelector: ".CF-audio-slider__input",
  _muteButtonSelector: ".CF-audio-control__mute-button",
  ...
  _hideTimelineButtonSelector: ".CF-audio-config__buttons > .CF-audio-config__menu-button:nth-child(1)",
  _hideWaveformButtonSelector: ".CF-audio-config__buttons > .CF-audio-config__menu-button:nth-child(2)",
