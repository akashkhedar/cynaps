...
module.exports = {
  ...
  _toolBarSelector: ".CF-toolbar",
  _zoomPresetsSelector: '[title^="Zoom presets"]',

  _rootSelector: '[class^="CF-object wrapperComponent--"]',
  _paginationSelector: '[class^="pagination--"]',
  _paginationPrevBtnSelector: ".CF-pagination__btn_arrow-left:not(.CF-pagination__btn_arrow-left-double)",
  _paginationNextBtnSelector: ".CF-pagination__btn_arrow-right:not(.CF-pagination__btn_arrow-right-double)",
  ...
  hasSelectedTool(toolCode) {
    I.seeElement(`.CF-tool_active${this.locateToolByCode(toolCode).toString()}`);
  },
