...
module.exports = {
  _topbarLocator: locate({ css: ".CF-topbar" }),
  _topbarAnnotationsToggle: locate({ css: ".CF-annotations-list__selected" }),
  _annotationsList: locate({ css: ".CF-annotations-list__list" }),
  _annotationsListItemSelector: ".CF-annotations-list__entity",
