 ...
 */
module.exports = {
  _rootSelector: ".CF-details",
  _labelSelector: ".CF-detailed-region .CF-labels-list span",
  _textSelector: ".CF-region-meta__content_type_text",
  _editMetaSelector: '[aria-label="Edit region\'s meta"]',
  _editableFieldInput: ".CF-region-editor__input",
  _editableFieldTitle: ".CF-region-editor__text",
  _metaField: ".CF-detailed-region__meta-text",
  _resultBlockSelector: ".CF-detailed-region__result",
  _resultTitleSelector: ".ant-typography,[class*='typography-']",
  _resultValueSelector: ".CF-region-meta__value",
  _sectionHeadSelector: ".CF-details__section-head",
  locateDetailPanel() {
