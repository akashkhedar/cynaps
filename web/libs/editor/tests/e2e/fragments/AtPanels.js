 ...
 */
class Panel {
  container = ".CF-sidepanels";
  root = ".CF-panel";
  detached = ".CF-panel_detached";
  aligmentLeft = ".CF-panel_alignment_left";
  aligmentRight = ".CF-panel_alignment_right";
  header = ".CF-panel__header";
  body = ".CF-panel__body";
  title = ".CF-panel__title";

  leftZone = ".CF-sidepanels__wrapper_align_left";
  rightZone = ".CF-sidepanels__wrapper_align_right";

  collapsingToggle = ".CF-panel__toggle";
