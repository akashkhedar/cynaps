...
module.exports = {
  _rootSelector: ".CF-outliner",
  _regionListSelector: ".CF-outliner-tree",
  _regionListItemSelector: ".CF-tree__node:not(.CF-tree__node_type_footer)",
  _regionListItemSelectedSelector: ".CF-tree-node-selected",
  _regionListItemIndex: ".CF-outliner-item__index",
  _regionVesibilityActionButton: ".CF-outliner-item__control_type_visibility button",
  _incompleteStateIcon: ".CF-outliner-item__incomplete",
  locateOutliner() {
