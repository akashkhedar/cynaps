...
module.exports = {
  _rootSelector: ".CF-video-segmentation",
  _videoRootSelector: ".CF-video__main",
  _trackSelector: ".CF-seeker__track",
  _indicatorSelector: ".CF-seeker__indicator",
  _positionSelector: ".CF-seeker__position",
