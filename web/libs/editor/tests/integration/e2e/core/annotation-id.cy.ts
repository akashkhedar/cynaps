...
describe("Annotation ID", () => {
  ...
  it("should have data-annotation-id attribute on all annotation buttons", () => {
    ...
    cy.get(".CF-annotation-button").should("have.length", 3);
    ...
    cy.get(".CF-annotation-button").eq(0).should("have.attr", "data-annotation-id", "1003");
    cy.get(".CF-annotation-button").eq(1).should("have.attr", "data-annotation-id", "1002");
    cy.get(".CF-annotation-button").eq(2).should("have.attr", "data-annotation-id", "1001");
  });
  ...
  it("should copy the correct annotation ID to clipboard", () => {
    ...
    cy.get(".CF-annotation-button__trigger").click();
    cy.get(".CF-dropdown:visible").find('[class*="option--"]').contains("Copy Annotation ID").click();
  ...
  it("should allow selecting annotation by data-annotation-id attribute", () => {
    ...
    cy.get('[data-annotation-id="2002"]').should("have.class", "CF-annotation-button_selected");
    ...
    cy.get('[data-annotation-id="2001"]').should("have.class", "CF-annotation-button_selected");
    cy.get('[data-annotation-id="2002"]').should("not.have.class", "CF-annotation-button_selected");
  });
});
