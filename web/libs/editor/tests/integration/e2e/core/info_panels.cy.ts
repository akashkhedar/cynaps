...
describe("Cynaps UI info panels", () => {
  it("Open every panel and interact with regions", () => {
    ...
    cy.get("[class$=CF-outliner-item__title").contains("Word1").should("be.visible");
    ...
    cy.get("[class$=CF-outliner-item__title").contains("Word2").should("be.visible");
