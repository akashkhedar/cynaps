import { Cynaps, Relations } from "@cynaps/frontend-test/helpers/CF";
...
describe("Linking modes: To comments", () => {
  it("should link region to comments", () => {
    ...
    Cynaps.params().config(simpleTextConfig).data(simpleTextData).withResult(simpleTextResult).init();
