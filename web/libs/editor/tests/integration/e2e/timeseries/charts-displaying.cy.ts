import { Cynaps, TimeSeries } from "@cynaps/frontend-test/helpers/CF";
import {
  multiChannelConfig,
  singleChannelConfig,
...
describe("TimeSeries charts displaying - MultiChannel", () => {
  it("should not displace charts while navigating", () => {
    ...
    Cynaps.params().config(multiChannelConfig).data(heavyDatasetForDisplacement).withResult([]).init();
...
describe("TimeSeries charts displaying - Single Channel", () => {
  it("should not displace charts while navigating", () => {
    ...
    Cynaps.params().config(singleChannelConfig).data(heavyDatasetForDisplacement).withResult([]).init();
