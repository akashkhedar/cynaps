...
import { Paragraphs } from "@cynaps/frontend-test/helpers/CF/Paragraphs";
import {
...
describe("Multiple Label Blocks - All Object Tags", () => {
  ...
  describe("Image Object Tag", () => {
    it("should create separate results for each label block - RectangleLabels", () => {
      cy.log("Initialize CF with Image and multiple RectangleLabels blocks");
      Cynaps.params()
    ...
    it("should create separate results for each label block - PolygonLabels", () => {
      cy.log("Initialize CF with Image and multiple PolygonLabels blocks");
      Cynaps.params()
  ...
  describe("Text Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize CF with Text and multiple Labels blocks");
      Cynaps.params()
  ...
  describe("HyperText Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize CF with HyperText and multiple HyperTextLabels blocks");
      Cynaps.params()
  ...
  describe("Paragraphs Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize CF with Paragraphs and multiple ParagraphLabels blocks");
      Cynaps.params()
  ...
  describe("Audio Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize CF with Audio and multiple Labels blocks");
      Cynaps.params()
  ...
  describe("TimeSeries Object Tag", () => {
    it("should create separate results for each label block", () => {
      cy.log("Initialize CF with TimeSeries and multiple TimeSeriesLabels blocks");
      Cynaps.params()
  ...
  describe("Video Object Tag", () => {
    ...
    it.skip("should create separate results for each label block", () => {
      cy.log("Initialize CF with Video and multiple Labels blocks");
      Cynaps.params()
    ...
    it("should create separate results for each timeline label block", () => {
      cy.log("Initialize CF with Video and multiple TimelineLabels blocks");
      Cynaps.params()
