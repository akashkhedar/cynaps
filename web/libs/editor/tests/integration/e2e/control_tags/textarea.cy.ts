import { Cynaps, Sidebar, Textarea, ToolBar } from "@cynaps/frontend-test/helpers/CF";
import {
  simpleData,
...
describe("Control Tags - TextArea - Lead Time", () => {
  ...
  it("should calculate lead_time for global TextArea", () => {
    Cynaps.params().config(textareaConfigSimple).data(simpleData).withResult([]).init();
  ...
  it("should calculate lead_time for per-region TextArea", () => {
    Cynaps.params().config(textareaConfigPerRegion).data(simpleData).withResult(textareaResultsPerRegion).init();
...
describe("Control Tags - TextArea - Pre-filled Value", () => {
  it("should display pre-filled value in the input field", () => {
    Cynaps.params().config(textareaConfigWithValue).data(simpleData).withResult([]).init();
  ...
  it("should show pre-filled value even when there are existing text regions", () => {
    ...
    Cynaps.params().config(textareaConfigWithValue).data(simpleData).withResult(existingResult).init();
  ...
  it("should work with multi-row textarea", () => {
    Cynaps.params().config(textareaConfigWithValueAndRows).data(simpleData).withResult([]).init();
...
describe("Control Tags - TextArea - Auto-submit on Annotation Submit", () => {
  ...
  it("should not auto-submit when maxSubmissions is reached and input is hidden", () => {
    Cynaps.params().config(textareaConfigWithMaxSubmissions).data(simpleData).withResult([]).init();
  ...
  it("should not auto-submit pre-filled value when maxSubmissions is reached", () => {
    Cynaps.params().config(textareaConfigWithValueAndMaxSubmissions).data(simpleData).withResult([]).init();
  ...
  it("should not auto-submit when annotation is loaded with maxSubmissions already reached", () => {
    ...
    Cynaps.params().config(textareaConfigWithMaxSubmissions).data(simpleData).withResult(existingResult).init();
