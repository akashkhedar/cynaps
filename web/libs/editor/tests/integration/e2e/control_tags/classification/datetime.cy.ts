import { Cynaps, ImageView, DateTime, Modals, Sidebar, ToolBar } from "@cynaps/frontend-test/helpers/CF";
import {
...
describe("Classification - single image - DateTime", () => {
  it("should create result without item_index", () => {
    Cynaps.params().config(simpleImageDateTimeConfig).data(simpleImageData).withResult([]).init();
...
describe("Classification - MIG perTag - DateTime", () => {
  it("should not have item_index in result", () => {
    Cynaps.params().config(perTagMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Cynaps.params().config(perTagMIGDateTimeConfig).data(simpleMIGData).withResult(perTagDateTimeResult).init();
  ...
  it("should require result", () => {
    Cynaps.params().config(requiredPerTagMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
...
describe("Control Tags - MIG perItem - DateTime", () => {
  it("should create result with item_index", () => {
    Cynaps.params().config(perItemMIGDateTimeConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Cynaps.params().config(perItemMIGDateTimeConfig).data(simpleMIGData).withResult(perItemDateTimeResult).init();
