import { Cynaps, ImageView, Textarea, ToolBar, Modals, Sidebar } from "@cynaps/frontend-test/helpers/CF";
import {
...
describe("Classification - single image - Textarea", () => {
  it("should create result without item_index", () => {
    Cynaps.params().config(simpleImageTextareaConfig).data(simpleImageData).withResult([]).init();
...
describe("Classification - MIG perTag - Textarea", () => {
  it("should not have item_index in result", () => {
    Cynaps.params().config(perTagMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perTag result correctly", () => {
    Cynaps.params().config(perTagMIGTextareaConfig).data(simpleMIGData).withResult(perTagTextareaResult).init();
  ...
  it("should require result", () => {
    Cynaps.params().config(requiredPerTagMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
...
describe("Control Tags - MIG perItem - Textarea", () => {
  it("should create result with item_index", () => {
    Cynaps.params().config(perItemMIGTextareaConfig).data(simpleMIGData).withResult([]).init();
  ...
  it("should load perItem result correctly", () => {
    Cynaps.params().config(perItemMIGTextareaConfig).data(simpleMIGData).withResult(perItemTextareaResult).init();
