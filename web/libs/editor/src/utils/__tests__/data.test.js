...
describe("parseValue", () => {
  const data = {
    html: '<a href="https://cynaps.io">Cynaps</a>',
    url: "https://cynaps.io",
    name: "Cynaps",
    num2str: "123",
    messages: {
  ...
  test("Variable", () => {
    expect(parseValue("$url", data)).toEqual("https://cynaps.io");
  });
  ...
  test("Text with one variable", () => {
    expect(parseValue("URL: $url", data)).toEqual("URL: https://cynaps.io");
  });

  test("Text with variables", () => {
    expect(parseValue("URL of $name is $url", data)).toEqual("URL of Cynaps is https://cynaps.io");
  });
