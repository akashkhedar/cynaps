import * as ff from "@cynaps/core/lib/utils/feature-flags/ff";
 ...
 * @param {url|text} [valueType=url|text]                 – source of the data, check (Data retrieval)[https://cynaps.io/guide/tasks.html] page for more inforamtion
