...
import { IconHelp } from "@cynaps/icons";
import { Toggle, Tooltip } from "@cynaps/ui";
import { cn } from "../../../utils/bem";
import { cnm } from "@cynaps/shad/utils";
...
const ParagraphAudio = observer(({ item }) => {
  ...
  return (
    <>
      {isBuffering && <div className="CF-timeline-controls__buffering" aria-label="Buffering Media Source" />}
      <audio
        {...audioDefaultProps}
