 ...
 * [Cynaps storage guide](../guide/storage.html#Troubleshoot-CORS-and-access-problems) for more
 ...
 * use Cynaps's signed URL support ([AWS](../guide/storage.html#Set-up-connection-in-the-Cynaps-UI),
 * [GCP](../guide/storage.html#Set-up-connection-in-the-Cynaps-UI-1), and
 * [Azure](../guide/storage.html#Set-up-connection-in-the-Cynaps-UI-2)).
 *
 * If the image is on the same host as your Cynaps instance, you can simply leave off the
 ...
 * @meta_description Customize Cynaps with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
