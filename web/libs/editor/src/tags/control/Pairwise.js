 ...
 * @meta_description Customize Cynaps with the Pairwise tag for object comparison tasks for machine learning and data science projects.
  ...
  .actions((self) => ({
    ...
    afterCreate() {
      ...
      if (self.selectionstyle) {
        ...
        // See: cynaps/web/libs/ui/src/tokens/tokens.js
        selection =
