...
import { IconOutlinerDrag, IconCollapseSmall, IconExpandSmall } from "@cynaps/ui";
...
enum DragOverHeightClasses {
  tabLeft = "CF-drag_over_tab_left",
  tabRight = "CF-drag_over_tab_right",
  emptyTabSpace = "CF-drag_over_empty_tab_space",
}
