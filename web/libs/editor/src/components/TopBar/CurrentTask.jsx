...
import { Button, IconChevronLeft, IconChevronRight, Tooltip } from "@cynaps/ui";
...
export const CurrentTask = observer(({ store }) => {
  ...
  // Note: store.hasInterface("postpone") is set by CF-sdk based on task.allow_postpone from API
  let canPostpone =
