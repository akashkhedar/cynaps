...
import { cnb as cn } from "@cynaps/core/lib/utils/bem";
import { alignElements, type Align } from "@cynaps/core/lib/utils/dom";
import { aroundTransition } from "@cynaps/core/lib/utils/transition";
...
export interface DropdownProps {
  ...
  /** Additional callback when visibility changes (from Cynaps) */
