import { Card, CardHeader, CardTitle, CardContent, CardDescription } from "@cynaps/ui/lib/card-new/card";
import { useMemo, isValidElement, useState, useEffect } from "react";
import { Redirect, Route, Switch, useParams, useRouteMatch } from "react-router-dom";
import { useUpdatePageTitle, createTitleFromSegments, getApiInstance } from "@cynaps/core";
...
import type { WrappedResponse } from "@cynaps/core/lib/api-proxy/types";

/**
 * FIXME: This is legacy imports. We're not supposed to use such statements
 * each one of these eventually has to be migrated to core/ui
 */
import { SidebarMenu } from "apps/cynaps/src/components/SidebarMenu/SidebarMenu";
