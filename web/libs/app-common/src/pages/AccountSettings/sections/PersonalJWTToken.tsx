import { Callout, CalloutContent, CalloutHeader, CalloutIcon, CalloutTitle } from "@cynaps/ui/lib/callout/callout";
import { IconWarning } from "@cynaps/icons";
import { atomWithMutation, atomWithQuery, queryClientAtom } from "jotai-tanstack-query";
import { useAtomValue } from "jotai";
import clsx from "clsx";
import { useCallback, useEffect, useMemo, useState } from "react";
import { format } from "date-fns";
import { useCopyText } from "@cynaps/core";
...
import { modal, confirm } from "@cynaps/ui/lib/modal";
import { Input, Label } from "apps/cynaps/src/components/Form/Elements";
    ...
    async (token: string) => {
      confirm({
        ...
        body: `Are you sure you want to delete this access token? Any application using this token will need a new token to be able to access ${
          window?.APP_SETTINGS?.app_name || "Cynaps"
        }`,
        okText: "Revoke",
        buttonLook: "negative",
        onOk: async () => {
