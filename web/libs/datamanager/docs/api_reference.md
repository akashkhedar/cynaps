...
DataManager uses Cynaps API to operate.
...
| Property    | Type             | Description                                               |
| ----------- | ---------------- | --------------------------------------------------------- |
| annotations | List<Annotation> | See Cynaps documentation to learn about annotations |
...
| Property    | Type             | Description                                                  |
| ----------- | ---------------- | ------------------------------------------------------------ |
| annotations | List<Annotation> | See Cynaps documentation to learn more about annotations |
