...
Cynaps DataManager is a vital component within the Cynaps ecosystem, designed to efficiently manage and navigate through annotated data. It provides users with advanced capabilities to organize, filter, and browse their datasets seamlessly.


### Features

DataManager boasts several key features, enhancing data handling within Cynaps:
...
- Integration with Cynaps Frontend: Ensures cohesive functionality with the Cynaps Frontend.
...
- **`yarn dm:watch`: Build DataManager continuously.**
    - This script is essential for development. It continuously builds DataManager, allowing developers to see their changes in real-time within the Cynaps environment.
...
DataManager integrates closely with Cynaps, handling various events:
