...
# https://api.cynaps.io/api-reference/introduction/getting-started#authentication
BASE_URL = os.getenv("CYNAPS_URL", "https://app.Cynaps.com")
...
ORG_ID = int(os.getenv("CYNAPS_ORG_ID", "1"))

# License data (status, usage analytics, user limits, etc.)
# https://api.cynaps.io/api-reference/api-reference/billing/info
print(ls.billing.info())

"""
Retrieve license details by user ID / email and validate active status of the license
https://api.cynaps.io/api-reference/api-reference/organizations/members/get
"""
user_id = None
for user in client.users.list():
    if user.email == os.getenv("CYNAPS_TEST_USER_EMAIL", "test1@test.com"):
