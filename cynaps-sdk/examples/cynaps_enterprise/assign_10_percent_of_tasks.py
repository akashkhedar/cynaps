...
CYNAPS_URL = os.getenv("CYNAPS_URL", "https://app.heartex.com")
API_KEY = os.getenv("CYNAPS_API_KEY", "<ls-api-key>")
client = Cynaps(base_url=CYNAPS_URL, api_key=API_KEY)
...
def run():
    ...
    """
    project_id = int(os.getenv("CYNAPS_PROJECT_ID", "12716"))
    reviewer_email = os.getenv("CYNAPS_REVIEWER_EMAIL", "your@email.com")
