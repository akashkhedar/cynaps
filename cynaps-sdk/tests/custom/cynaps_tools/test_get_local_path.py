...
from cynaps_sdk._extensions.cynaps_tools.core.utils.io import (
    get_local_path,
    _DIR_APP_NAME,
)
...
@patch(
    "cynaps_sdk._extensions.cynaps_tools.core.utils.io.get_data_dir",
    return_value="test-data-dir/",
)
@patch(
    "cynaps_sdk._extensions.cynaps_tools.core.utils.io.get_cache_dir",
...
@patch("cynaps_sdk._extensions.cynaps_tools.core.utils.io.get_data_dir", return_value="test-data-dir/")
@patch("cynaps_sdk._extensions.cynaps_tools.core.utils.io.get_cache_dir", return_value="test-data-dir/.cache/cynaps")
@patch("cynaps_sdk._extensions.cynaps_tools.core.utils.io.LOCAL_FILES_DOCUMENT_ROOT", "/my_files")
