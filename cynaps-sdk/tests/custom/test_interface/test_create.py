...
import cynaps_sdk.cynaps_interface.create as CE
from cynaps_sdk.cynaps_interface.control_tags import ChoicesTag
from cynaps_sdk.cynaps_interface.object_tags import TextTag
