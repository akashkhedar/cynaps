"""PathTrack BBoxes to Cynaps convert
...
def convert_shot(
    ...
    """Convert bounding boxes from PathTrack to Cynaps video format
...
def convert_dataset(
    ...
    """Convert PathTrack dataset to Cynaps video labeling format
    ...
    logger.info("Saving Cynaps JSON: %s", path)
