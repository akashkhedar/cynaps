...
from cynaps_sdk.converter import brush
from cynaps_sdk.converter.audio import convert_to_asr_json_manifest
from cynaps_sdk.converter.keypoints import (
...
from cynaps_sdk.converter.exports import csv2
from cynaps_sdk.converter.utils import (
    parse_config,
...
from cynaps_sdk.converter.exports.yolo import process_and_save_yolo_annotations
...
class Converter(object):
    _FORMAT_INFO = {
        Format.JSON: {
            ...
            "and the annotations for a dataset. It's Cynaps Common Format",
            "link": "https://cynaps.io/guide/export.html#JSON",
        },
        Format.JSON_MIN: {
            "title": "JSON-MIN",
            ...
            "link": "https://cynaps.io/guide/export.html#JSON-MIN",
        },
        Format.CSV: {
            "title": "CSV",
        ...
        Format.COCO: {
            ...
            "link": "https://cynaps.io/guide/export.html#COCO",
        ...
        Format.VOC: {
            ...
            "link": "https://cynaps.io/guide/export.html#Pascal-VOC-XML",
        ...
        Format.YOLO: {
            ...
            "link": "https://cynaps.io/guide/export.html#YOLO",
            "tags": ["image segmentation", "object detection", "keypoints"],
        },
        ...
        Format.BRUSH_TO_NUMPY: {
            ...
            "link": "https://cynaps.io/guide/export.html#Brush-labels-to-NumPy-amp-PNG",
        ...
        Format.ASR_MANIFEST: {
            ...
            "link": "https://cynaps.io/guide/export.html#ASR-MANIFEST",
    ...
    def __init__(
        ...
        """Initialize Cynaps Converter for Exports

        :param config: string or dict: XML string with Cynaps labeling config or path to this file or parsed_config
    ...
    def convert(self, input_data, output_data, format, is_dir=True, **kwargs):
        ...
        if format == Format.JSON:
            ...
            from cynaps_sdk.converter.exports.brush_to_coco import convert_to_coco
    ...
    def convert_to_coco(
        ...
        for item_idx, item in enumerate(item_iterator):
            ...
            for label in labels:
                ...
                if os.getenv("CYNAPS_FORCE_ANNOTATOR_EXPORT"):
    ...
    def rotated_rectangle(label):
        ...
        if abs(label_r) > 0:
            ...
            beta = math.pi * (
                label_r / 180
            )  # Cynaps defines the angle towards the vertical axis

            radius = math.sqrt((label_w / 2) ** 2 + (label_h / 2) ** 2)

            # Cynaps saves the position of top left corner after rotation
            x_0 = (
                label_x
                - radius
    ...
    def convert_to_voc(
        ...
        for item_idx, item in enumerate(item_iterator):
            ...
            create_child_node(doc, "name", "Cynaps", owner_node)
