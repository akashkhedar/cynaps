...
from cynaps_sdk.converter.utils import ensure_dir, get_annotator
import cynaps_sdk.converter.brush as brush_module
...
def convert_to_coco(items, output_dir, output_image_dir=None):
    """Convert Cynaps annotations to COCO format
    ...
    coco_data = {
        ...
        'info': {
            ...
            'version': '1.0',
            'description': 'Converted from Cynaps',
            'contributor': 'Cynaps Converter',
