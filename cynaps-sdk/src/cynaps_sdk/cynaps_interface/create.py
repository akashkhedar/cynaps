...
from cynaps_sdk.cynaps_interface.base import CynapsTag

import cynaps_sdk.cynaps_interface.object_tags as OT
import cynaps_sdk.cynaps_interface.control_tags as CT
...
def _convert(name: str, tag: Union[str, list, tuple, CynapsTag]) -> tuple:
    """
    ...
    Raises:
        TypeError: If input tag is not a str, list, tuple, or CynapsTag.
    """
    
    if isinstance(tag, CynapsTag):
        ...
        raise TypeError("Input tag must be one of str, list, tuple, CynapsTag")
