...
from .base import CynapsTag, get_tag_class
...
class ControlTag(CynapsTag):
    """
    Class that represents a ControlTag in Cynaps
    ...
    def validate_value(self, value: dict) -> bool:
        """
        Given "value" from [annotation result format](https://cynaps.io/guide/task_format),
