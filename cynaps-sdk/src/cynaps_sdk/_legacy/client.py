...
HEADERS = {}
CYNAPS_DEFAULT_URL = "http://localhost:8080"
...
class Client(object):
    def __init__(
        ...
        """Initialize the client. Do this before using other Cynaps SDK classes and methods in your script.
        ...
        api_key: str
            User token for the API. You can find this on your user account page in Cynaps.
        ...
        versions: dict
            Versions of Cynaps components for the connected instance
        make_request_raise: bool
            If true, make_request will raise exceptions on request errors
        """
        if not url:
            url = os.getenv("CYNAPS_URL", CYNAPS_DEFAULT_URL)
        self.url = url.rstrip("/")
        ...
        if api_key is None and credentials is None:
            raise RuntimeError(
                "If neither 'api_key' nor 'credentials' are provided, 'CYNAPS_API_KEY' environment variable must "
                "be set"
            )
        ...
        self.is_enterprise = "cynaps-enterprise-backend" in self.versions

    def get_versions(self):
        """Call /version api and get all Cynaps component versions

        Returns
        -------
        dict with Cynaps component names and their versions
    ...
    def check_connection(self):
        """Call Cynaps /health endpoint to check the connection to the server.
    ...
    def get_projects(self, **query_params):
        """List all projects in Cynaps.

        Returns
        -------
        list or `cynaps_sdk.project.Project` instances

        """
        return self.list_projects(**query_params)

    def delete_project(self, project_id: int):
        """Delete a project in Cynaps.
    ...
    def delete_all_projects(self):
        """Deletes all projects in Cynaps.
    ...
    def get_project(self, id):
        """Return project SDK object by ID existed in Cynaps
    ...
    def get_workspaces(self):
        ...
        Returns
        -------
        list of `cynaps_sdk.workspaces.Workspace`
        ...
        assert (
            self.is_enterprise
        ), "Workspaces are available only for Enterprise instance of Cynaps"
    ...
    def get_workspace_by_title(self, title):
        ...
        Returns
        -------
        `cynaps_sdk.workspaces.Workspace` or None
    ...
    def get_url(self, suffix):
        """Get the URL of the Cynaps server
    ...
    def make_request(self, method, url, *args, **kwargs):
        """Make a request with an API key to Cynaps instance
