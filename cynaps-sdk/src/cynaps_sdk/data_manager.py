""" # Data Manager module for the Cynaps SDK

    Classes can be used to filter, order, and select items in `cynaps_sdk.project.Project.get_tasks`
    ...
    ```python
    from cynaps_sdk.data_manager import Filters, Column, Operator, Type
...
class Filters:
    """
    Use the methods and variables in this class to create and combine filters for tasks on the Cynaps Data Manager.
    """
    ...
    def create(conjunction, items):
        """Create a filter for `cynaps_sdk.project.Project.get_tasks()`
...
class Column:
    """Specify the column on the Data Manager in Cynaps UI to use in the filter."""
