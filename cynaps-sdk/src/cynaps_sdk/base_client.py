...
import typing
from .environment import CynapsEnvironment
import os
import httpx
...
class CynapsBase:
    ...
    environment : CynapsEnvironment
        The environment to use for requests from the client. from .environment import CynapsEnvironment



        Defaults to CynapsEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        environment: CynapsEnvironment = CynapsEnvironment.DEFAULT,
        api_key: typing.Optional[str] = os.getenv("CYNAPS_API_KEY"),
        ...
        if api_key is None:
            raise ApiError(
                body="The client must be instantiated be either passing in api_key or setting CYNAPS_API_KEY"
            )
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: CynapsEnvironment) -> str:
