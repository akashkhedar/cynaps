# Cynaps Python Library

[![fern shield](https://img.shields.io/badge/%F0%9F%8C%BF-SDK%20generated%20by%20Fern-brightgreen)](https://github.com/fern-api/fern)
[![pypi](https://img.shields.io/pypi/v/cynaps-sdk.svg)](https://pypi.python.org/pypi/cynaps-sdk)

The Cynaps Python Library provides convenient access to the Cynaps API from applications written in Python.
...
Explore the Cynaps API documentation [here](https://cynaps.xyz/docs).

# Installation

```sh
pip install --upgrade cynaps-sdk
# or
...
If you use the Cynaps SDK 1 package in any automated pipelines, we strongly recommend pinning your SDK version to `<2.0.0` until you can reconcile the breaking changes.

## SDK <1

The version of `cynaps-sdk<1` is deprecated and no longer supported. We recommend updating to the latest version.

<details>

<summary> To use SDK <1 </summary>

If you still want to use the deprecated version, you can install it with `pip install "cynaps-sdk<1"`.
...
from cynaps_sdk._legacy import Project
```
...
client = Cynaps(
    base_url="http://localhost:8080",   # <-- put your Cynaps URL here
...
task = client.tasks.create(
    project=project.id,
    data={"text": "Cynaps is the best!"}  # 'text' matches value="$text"
)
...
client.projects.import_tasks(
    ...
    request=[
        {"text": "I love Cynaps"},
        {"text": "Cynaps helps me ship faster"},
    ]
)
```

For additional examples, see [our API reference](https://cynaps.xyz/docs).

<!-- Begin Contributing, generated by Fern  -->

# Contributing

Please follow [this guide to contribute to the SDK](https://github.com/cynaps/cynaps-client-generator?tab=readme-ov-file#how-to-contribute)
