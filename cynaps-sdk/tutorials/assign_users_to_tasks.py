...
# 2. Set CYNAPS_URL and CYNAPS_API_KEY env vars, CYNAPS_URL should start with https:// or http://
...
# (You can get project ID from the URL, e.g. https://app.cynaps.xyz/projects/<PROJECT_ID>)
...
def main():
    ...
    if not api_key or not base_url:
        print("ERROR: set CYNAPS_API_KEY and CYNAPS_URL env var")
        sys.exit(1)
